...
#'
#' CmdStan reads its default thread count from STAN_NUM_THREADS, so the
#' count is set for the child alone and the session never sees it. Under
#' WSL the variable also has to be named in WSLENV to reach Linux.
#'
#' @noRd

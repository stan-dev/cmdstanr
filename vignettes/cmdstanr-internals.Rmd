...
corresponding to variables in their respective model block. Transformed 
data variables are not listed as they are not used in the models input
or output.
...
information (`real` or `int`) and the number of dimensions.

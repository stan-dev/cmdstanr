...
(currently limited to `real` or `int`) and the number of dimensions. Here
"number of dimensions" means the number of indexing dimensions in the declared
Stan variable (scalar = 0, vector = 1, matrix = 2, etc.). See `?variables` for
more details.

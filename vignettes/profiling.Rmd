...
output: 
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 4
bibliography: profiling-files/profiling.bib
params:
...
perspective, see [@gelman2020bayesian].
...
method, which returns one data frame per chain (profiles across multiple
...
We can see from the `total_time` column that this is much faster.

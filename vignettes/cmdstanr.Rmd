...
The
[`$cmdstan_summary()`](https://mc-stan.org/cmdstanr/reference/CmdStanMCMC.html) and
[`$cmdstan_diagnose()`](https://mc-stan.org/cmdstanr/reference/CmdStanMCMC.html) methods

...
argument. If `mode` is omitted then optimization will be run internally before
...
much faster [`qs2`](https://github.com/qsbase/qs2) format. The saved object

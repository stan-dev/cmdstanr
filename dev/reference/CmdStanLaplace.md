...
| [`$mode()`](https://mc-stan.org/cmdstanr/dev/reference/fit-method-mode.md) | Return the mode as a [`CmdStanMLE`](https://mc-stan.org/cmdstanr/dev/reference/CmdStanMLE.md) object. |

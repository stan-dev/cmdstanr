...
#>  $ start_datetime      : chr "2026-09-12 07:52:26 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmpy5voxY/logistic-profile-202609120752-01-9625ef.csv"
...
#>   ..$ warmup  : num [1:4] 0.019 0.02 0.019 0.019
#>   ..$ sampling: num [1:4] 0.054 0.059 0.056 0.053
#>   ..$ total   : num [1:4] 0.073 0.079 0.075 0.072
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-09-12 07:52:27 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpy5voxY/logistic-profile-202609120752-01-0723c6.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpy5voxY/logistic-profile-202609120752-01-8314db.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

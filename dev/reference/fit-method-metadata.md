...
#>  $ start_datetime      : chr "2026-07-17 20:26:23 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmpad1Dmz/logistic-profile-202607172026-1-9625a0.csv"
...
#>   ..$ sampling: num [1:4] 0.055 0.059 0.057 0.055
#>   ..$ total   : num [1:4] 0.075 0.079 0.076 0.074
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-07-17 20:26:24 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpad1Dmz/logistic-profile-202607172026-1-072377.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpad1Dmz/logistic-profile-202607172026-1-83148c.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

...
#>  $ start_datetime      : chr "2026-08-27 23:18:00 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmph3DGHt/logistic-profile-202608272318-01-96265f.csv"
...
#>   ..$ warmup  : num [1:4] 0.02 0.02 0.02 0.019
#>   ..$ sampling: num [1:4] 0.054 0.059 0.057 0.055
#>   ..$ total   : num [1:4] 0.074 0.079 0.077 0.074
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-08-27 23:18:01 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmph3DGHt/logistic-profile-202608272318-01-072436.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmph3DGHt/logistic-profile-202608272318-01-83154b.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

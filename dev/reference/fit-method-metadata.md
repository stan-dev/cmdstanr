...
#>  $ start_datetime      : chr "2026-08-04 18:29:49 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmpd8UYpB/logistic-profile-202608041829-1-962cc7.csv"
...
#>   ..$ sampling: num [1:4] 0.053 0.058 0.056 0.053
#>   ..$ total   : num [1:4] 0.072 0.078 0.075 0.072
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpd8UYpB/logistic-profile-202608041829-1-072a9e.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-08-04 18:29:50 UTC"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpd8UYpB/logistic-profile-202608041829-1-831bb3.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

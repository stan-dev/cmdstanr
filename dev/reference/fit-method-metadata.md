...
#>  $ start_datetime      : chr "2026-09-22 22:20:21 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpIm9Q7M/logistic-profile-202609222220-01-962643.csv"
...
#>  $ step_size_adaptation: num [1:4] 0.751 0.687 0.723 0.832
...
#>   ..$ warmup  : num [1:4] 0.017 0.018 0.017 0.017
#>   ..$ sampling: num [1:4] 0.052 0.053 0.053 0.049
#>   ..$ total   : num [1:4] 0.069 0.071 0.07 0.066
...
#>  $ stan_version_minor : num 40
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-09-22 22:20:22 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpIm9Q7M/logistic-profile-202609222220-01-07241a.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.40.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpIm9Q7M/logistic-profile-202609222220-01-83152f.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.40.0"

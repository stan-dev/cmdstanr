...
#>  $ start_datetime      : chr "2026-09-08 21:07:59 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpawADsT/logistic-profile-202609082107-01-9625a9.csv"
...
#>   ..$ warmup  : num [1:4] 0.016 0.016 0.015 0.015
#>   ..$ sampling: num [1:4] 0.043 0.05 0.045 0.042
#>   ..$ total   : num [1:4] 0.059 0.066 0.06 0.057
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpawADsT/logistic-profile-202609082107-01-072380.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-09-08 21:08:00 UTC"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpawADsT/logistic-profile-202609082108-01-831495.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

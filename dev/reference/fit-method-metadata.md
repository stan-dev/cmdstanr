...
#>  $ start_datetime      : chr "2026-04-10 01:06:25 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpiwyiwU/logistic-profile-202604100106-1-3e31fd.csv"
...
#>   ..$ sampling: num [1:4] 0.056 0.055 0.052 0.054
#>   ..$ total   : num [1:4] 0.074 0.074 0.071 0.073
...
#>  $ stan_version_minor : num 38
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-04-10 01:06:26 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpiwyiwU/logistic-profile-202604100106-1-02b5f1.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpiwyiwU/logistic-profile-202604100106-1-6790c9.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
#>  $ sampler_diagnostics: chr(0) 

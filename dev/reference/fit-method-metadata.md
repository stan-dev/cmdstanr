...
#>  $ start_datetime      : chr "2026-05-04 09:16:41 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmplllXhl/logistic-profile-202605040916-1-02b650.csv"
...
#>   ..$ warmup  : num [1:4] 0.019 0.019 0.018 0.018
#>   ..$ sampling: num [1:4] 0.054 0.055 0.056 0.054
#>   ..$ total   : num [1:4] 0.073 0.074 0.074 0.072
...
#>  $ stan_version_minor : num 38
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-05-04 09:16:42 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmplllXhl/logistic-profile-202605040916-1-679128.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmplllXhl/logistic-profile-202605040916-1-24a0d4.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
#>  $ sampler_diagnostics: chr(0) 

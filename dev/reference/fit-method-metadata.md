...
#>  $ start_datetime      : chr "2026-08-05 15:07:32 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmp4zayZw/logistic-profile-202608051507-1-962c82.csv"
...
#>   ..$ sampling: num [1:4] 0.054 0.059 0.057 0.054
#>   ..$ total   : num [1:4] 0.074 0.079 0.076 0.073
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-08-05 15:07:33 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmp4zayZw/logistic-profile-202608051507-1-072a59.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmp4zayZw/logistic-profile-202608051507-1-831b6e.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

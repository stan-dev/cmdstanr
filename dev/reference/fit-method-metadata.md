...
#>  $ start_datetime      : chr "2026-08-05 19:59:35 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmpa2miWw/logistic-profile-202608051959-1-962738.csv"
...
#>   ..$ sampling: num [1:4] 0.052 0.058 0.055 0.054
#>   ..$ total   : num [1:4] 0.072 0.078 0.074 0.073
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-08-05 19:59:36 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpa2miWw/logistic-profile-202608051959-1-07250f.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpa2miWw/logistic-profile-202608051959-1-831624.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

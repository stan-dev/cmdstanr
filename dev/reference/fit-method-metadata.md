...
#>  $ start_datetime      : chr "2026-06-05 07:55:48 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpXAkxdu/logistic-profile-202606050755-1-02b584.csv"
...
#>   ..$ warmup  : num [1:4] 0.018 0.018 0.017 0.018
#>   ..$ sampling: num [1:4] 0.05 0.051 0.052 0.05
#>   ..$ total   : num [1:4] 0.068 0.069 0.069 0.068
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-06-05 07:55:49 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpXAkxdu/logistic-profile-202606050755-1-67905c.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpXAkxdu/logistic-profile-202606050755-1-24a008.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

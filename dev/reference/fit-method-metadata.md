...
#>  $ start_datetime      : chr "2026-06-05 15:44:23 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpqnDjuF/logistic-profile-202606051544-1-962675.csv"
...
#>   ..$ warmup  : num [1:4] 0.02 0.02 0.02 0.02
#>   ..$ sampling: num [1:4] 0.055 0.06 0.058 0.055
#>   ..$ total   : num [1:4] 0.075 0.08 0.078 0.075
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-06-05 15:44:24 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpqnDjuF/logistic-profile-202606051544-1-07244c.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpqnDjuF/logistic-profile-202606051544-1-831561.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

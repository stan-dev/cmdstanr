...
#>  $ start_datetime      : chr "2025-12-03 18:56:56 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmpf5Zbzn/logistic-profile-202512031856-1-874142.csv"
...
#>   ..$ warmup  : num [1:4] 0.019 0.018 0.019 0.018
#>   ..$ sampling: num [1:4] 0.049 0.05 0.053 0.048
#>   ..$ total   : num [1:4] 0.068 0.068 0.072 0.066
...
#>  $ stan_version_minor : num 37
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2025-12-03 18:56:57 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpf5Zbzn/logistic-profile-202512031856-1-0595e9.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.37.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmpf5Zbzn/logistic-profile-202512031856-1-3e03f6.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.37.0"
#>  $ sampler_diagnostics: chr(0) 

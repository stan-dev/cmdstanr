...
#>  $ start_datetime      : chr "2026-09-14 23:00:10 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpoN8Uga/logistic-profile-202609142300-01-96245f.csv"
...
#>   ..$ warmup  : num [1:4] 0.013 0.014 0.012 0.017
#>   ..$ sampling: num [1:4] 0.035 0.039 0.036 0.042
#>   ..$ total   : num [1:4] 0.048 0.053 0.048 0.059
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-09-14 23:00:11 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpoN8Uga/logistic-profile-202609142300-01-072236.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpoN8Uga/logistic-profile-202609142300-01-83134b.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

...
#>  $ start_datetime      : chr "2026-09-14 18:59:23 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpB3SF94/logistic-profile-202609141859-01-96259a.csv"
...
#>   ..$ warmup  : num [1:4] 0.018 0.018 0.018 0.018
#>   ..$ sampling: num [1:4] 0.05 0.054 0.052 0.049
#>   ..$ total   : num [1:4] 0.068 0.072 0.07 0.067
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpB3SF94/logistic-profile-202609141859-01-072371.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"
...
#>  $ stan_version_minor : num 39
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-09-14 18:59:24 UTC"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpB3SF94/logistic-profile-202609141859-01-831486.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.39.0"

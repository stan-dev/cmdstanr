...
#>  $ start_datetime      : chr "2026-03-19 00:20:18 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpyUS9gD/logistic-profile-202603190020-1-3e349e.csv"
...
#>   ..$ sampling: num [1:4] 0.053 0.053 0.049 0.051
#>   ..$ total   : num [1:4] 0.071 0.071 0.067 0.069
...
#>  $ stan_version_minor : num 38
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-03-19 00:20:19 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpyUS9gD/logistic-profile-202603190020-1-02b892.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpyUS9gD/logistic-profile-202603190020-1-67936a.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
#>  $ sampler_diagnostics: chr(0) 

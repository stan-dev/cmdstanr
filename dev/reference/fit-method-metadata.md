...
#>  $ start_datetime      : chr "2026-03-31 01:24:45 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/Rtmp4hU51z/logistic-profile-202603310124-1-3e332a.csv"
...
#>   ..$ warmup  : num [1:4] 0.019 0.019 0.019 0.02
#>   ..$ sampling: num [1:4] 0.058 0.057 0.054 0.057
#>   ..$ total   : num [1:4] 0.077 0.076 0.073 0.077
...
#>  $ stan_version_minor : num 38
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-03-31 01:24:46 UTC"
#>  $ method             : chr "optimize"
#>  $ algorithm          : chr "lbfgs"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmp4hU51z/logistic-profile-202603310124-1-02b71e.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/Rtmp4hU51z/logistic-profile-202603310124-1-6791f6.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
#>  $ sampler_diagnostics: chr(0) 

...
This outlines how to propose a change to cmdstanr and is based on
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("stan-dev/cmdstanr", fork = TRUE)`.
...
Please note that the cmdstanr project follows the Stan project’s [Code
of

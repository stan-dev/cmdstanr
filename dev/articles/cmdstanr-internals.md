...
Warning in '/tmp/Rtmp2wnUU1/model-39947c9ecf5a.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp2wnUU1/model-39947c9ecf5a.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/Rtmp2wnUU1/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp2wnUU1/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/Rtmp2wnUU1/bernoulli-202602242222-1-5be4cc.csv"
    [2] "/tmp/Rtmp2wnUU1/bernoulli-202602242222-2-5be4cc.csv"
    [3] "/tmp/Rtmp2wnUU1/bernoulli-202602242222-3-5be4cc.csv"
    [4] "/tmp/Rtmp2wnUU1/bernoulli-202602242222-4-5be4cc.csv"
...
```
    ...
    Ncells 1217942 65.1    2507520  134  1583622 84.6
    Vcells 2118589 16.2    8388608   64  4895083 37.4
...
```
    ...
    List of 8
     $ metadata                       :List of 41
      ...
      ..$ start_datetime      : chr "2026-02-24 22:22:45 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/Rtmp2wnUU1/bernoulli-profile-202602242222-1-2c709c.csv"
...
```
    ...
    [1] "/tmp/Rtmp2wnUU1/bernoulli-diagnostic-202602242222-1-057321.csv"
    [2] "/tmp/Rtmp2wnUU1/bernoulli-diagnostic-202602242222-2-057321.csv"
    [3] "/tmp/Rtmp2wnUU1/bernoulli-diagnostic-202602242222-3-057321.csv"
    [4] "/tmp/Rtmp2wnUU1/bernoulli-diagnostic-202602242222-4-057321.csv"
...
```
    ...
    Running make /tmp/Rtmp2wnUU1/model-3994135dec59 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/Rtmp2wnUU1/model-3994135dec59.hpp /tmp/Rtmp2wnUU1/model-3994135dec59.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/Rtmp2wnUU1/model-3994135dec59.o /tmp/Rtmp2wnUU1/model-3994135dec59.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/Rtmp2wnUU1/model-3994135dec59.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/Rtmp2wnUU1/model-3994135dec59
    rm /tmp/Rtmp2wnUU1/model-3994135dec59.o /tmp/Rtmp2wnUU1/model-3994135dec59.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/Rtmp2wnUU1/standata-3994bd1b2ce.json' output \
      'file=/tmp/Rtmp2wnUU1/bernoulli-202602242222-1-1e14ee.csv' \
      'profile_file=/tmp/Rtmp2wnUU1/bernoulli-profile-202602242222-1-3dccc9.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/Rtmp2wnUU1/standata-3994bd1b2ce.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/Rtmp2wnUU1/bernoulli-202602242222-1-1e14ee.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/Rtmp2wnUU1/bernoulli-profile-202602242222-1-3dccc9.csv 

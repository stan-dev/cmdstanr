...
```
    ...
    [1] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523.stan"
...
```
    ...
    [1] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523"
...
Warning in '/tmp/Rtmp54lm5Y/model-3961417529bc.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp54lm5Y/model-3961417529bc.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/Rtmp54lm5Y/model_287cd4f50e093cb87805d29fd774bdf8.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp54lm5Y/model_287cd4f50e093cb87805d29fd774bdf8.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-01-5be499.csv"
    [2] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-02-5be499.csv"
    [3] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-03-5be499.csv"
    [4] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-04-5be499.csv"
...
```
    ...
    Ncells 1274248 68.1    2633471 140.7  1653910 88.4
    Vcells 2194933 16.8    8388608  64.0  4906806 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-08-25 19:56:12 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-profile-202608251956-01-2c7069.csv"
      ...
      ..$ model_name          : chr "bernoulli_3961506ac523_model"
      ..$ adapt_engaged       : int 1
      ..$ adapt_delta         : num 0.8
      ...
      .. ..$ sampling: num [1:4] 0.004 0.005 0.004 0.005
      .. ..$ total   : num [1:4] 0.006 0.007 0.006 0.007
...
```
    ...
    [1] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-diagnostic-202608251956-01-0572ee.csv"
    [2] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-diagnostic-202608251956-02-0572ee.csv"
    [3] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-diagnostic-202608251956-03-0572ee.csv"
    [4] "/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-diagnostic-202608251956-04-0572ee.csv"
...
```
    ...
    Running make /tmp/Rtmp54lm5Y/model-396185c3883 \
      'STANCFLAGS +=  --name=bernoulli-3961506ac523_model'

    --- Translating Stan model to C++ code ---
    bin/stanc --name=bernoulli-3961506ac523_model --o=/tmp/Rtmp54lm5Y/model-396185c3883.hpp /tmp/Rtmp54lm5Y/model-396185c3883.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/Rtmp54lm5Y/model-396185c3883.o /tmp/Rtmp54lm5Y/model-396185c3883.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.39.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.39.0/stan/lib/stan_math/lib/tbb"      /tmp/Rtmp54lm5Y/model-396185c3883.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/Rtmp54lm5Y/model-396185c3883
    rm /tmp/Rtmp54lm5Y/model-396185c3883.hpp /tmp/Rtmp54lm5Y/model-396185c3883.o
...
```
    ...
    Running ./bernoulli-3961506ac523 'id=1' random 'seed=1376020223' data \
      'file=/tmp/Rtmp54lm5Y/standata-39616c2b6e8d.json' output \
      'file=/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-01-1e14bb.csv' \
      'profile_file=/tmp/Rtmp54lm5Y/bernoulli-3961506ac523-profile-202608251956-01-3dcc96.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/Rtmp54lm5Y/standata-39616c2b6e8d.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/Rtmp54lm5Y/bernoulli-3961506ac523-202608251956-01-1e14bb.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/Rtmp54lm5Y/bernoulli-3961506ac523-profile-202608251956-01-3dcc96.csv 

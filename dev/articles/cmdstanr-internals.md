...
Warning in '/tmp/RtmpFZY8dZ/model-39d825c6bbfc.stan', line 11, column 14: A
...
Warning in '/tmp/RtmpFZY8dZ/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14: A
    poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
Warning: The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
...
```
    ...
    [1] "/tmp/RtmpFZY8dZ/bernoulli-202601022131-1-5be510.csv"
    [2] "/tmp/RtmpFZY8dZ/bernoulli-202601022131-2-5be510.csv"
    [3] "/tmp/RtmpFZY8dZ/bernoulli-202601022131-3-5be510.csv"
    [4] "/tmp/RtmpFZY8dZ/bernoulli-202601022131-4-5be510.csv"
...
```
    ...
    Ncells 1220228 65.2    2509950 134.1  1591825 85.1
    Vcells 2122607 16.2    8388608  64.0  4904942 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-01-02 21:31:29 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/RtmpFZY8dZ/bernoulli-profile-202601022131-1-2c70e0.csv"
...
```
    ...
    [1] "/tmp/RtmpFZY8dZ/bernoulli-diagnostic-202601022131-1-057365.csv"
    [2] "/tmp/RtmpFZY8dZ/bernoulli-diagnostic-202601022131-2-057365.csv"
    [3] "/tmp/RtmpFZY8dZ/bernoulli-diagnostic-202601022131-3-057365.csv"
    [4] "/tmp/RtmpFZY8dZ/bernoulli-diagnostic-202601022131-4-057365.csv"
...
```
    ...
    Running make /tmp/RtmpFZY8dZ/model-39d81e4757b7 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/RtmpFZY8dZ/model-39d81e4757b7.hpp /tmp/RtmpFZY8dZ/model-39d81e4757b7.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/RtmpFZY8dZ/model-39d81e4757b7.o /tmp/RtmpFZY8dZ/model-39d81e4757b7.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.37.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.37.0/stan/lib/stan_math/lib/tbb"      /tmp/RtmpFZY8dZ/model-39d81e4757b7.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/RtmpFZY8dZ/model-39d81e4757b7
    rm /tmp/RtmpFZY8dZ/model-39d81e4757b7.o /tmp/RtmpFZY8dZ/model-39d81e4757b7.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/RtmpFZY8dZ/standata-39d86dda4ac1.json' output \
      'file=/tmp/RtmpFZY8dZ/bernoulli-202601022131-1-1e1532.csv' \
      'profile_file=/tmp/RtmpFZY8dZ/bernoulli-profile-202601022131-1-3dcd0d.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/RtmpFZY8dZ/standata-39d86dda4ac1.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/RtmpFZY8dZ/bernoulli-202601022131-1-1e1532.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/RtmpFZY8dZ/bernoulli-profile-202601022131-1-3dcd0d.csv 

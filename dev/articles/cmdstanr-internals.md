...
Warning in '/tmp/RtmppXQ3Dy/model-38a0a71879a.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmppXQ3Dy/model-38a0a71879a.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/RtmppXQ3Dy/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmppXQ3Dy/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/RtmppXQ3Dy/bernoulli-202604182139-1-5be3d8.csv"
    [2] "/tmp/RtmppXQ3Dy/bernoulli-202604182139-2-5be3d8.csv"
    [3] "/tmp/RtmppXQ3Dy/bernoulli-202604182139-3-5be3d8.csv"
    [4] "/tmp/RtmppXQ3Dy/bernoulli-202604182139-4-5be3d8.csv"
...
```
    ...
    Ncells 1234068 66.0    2545400  136  1600010 85.5
    Vcells 2143252 16.4    8388608   64  4863129 37.2
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-04-18 21:39:10 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/RtmppXQ3Dy/bernoulli-profile-202604182139-1-2c6fa8.csv"
...
```
    ...
    [1] "/tmp/RtmppXQ3Dy/bernoulli-diagnostic-202604182139-1-05722d.csv"
    [2] "/tmp/RtmppXQ3Dy/bernoulli-diagnostic-202604182139-2-05722d.csv"
    [3] "/tmp/RtmppXQ3Dy/bernoulli-diagnostic-202604182139-3-05722d.csv"
    [4] "/tmp/RtmppXQ3Dy/bernoulli-diagnostic-202604182139-4-05722d.csv"
...
```
    ...
    Running make /tmp/RtmppXQ3Dy/model-38a0dd1740d \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/RtmppXQ3Dy/model-38a0dd1740d.hpp /tmp/RtmppXQ3Dy/model-38a0dd1740d.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/RtmppXQ3Dy/model-38a0dd1740d.o /tmp/RtmppXQ3Dy/model-38a0dd1740d.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/RtmppXQ3Dy/model-38a0dd1740d.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/RtmppXQ3Dy/model-38a0dd1740d
    rm /tmp/RtmppXQ3Dy/model-38a0dd1740d.o /tmp/RtmppXQ3Dy/model-38a0dd1740d.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/RtmppXQ3Dy/standata-38a03626d13e.json' output \
      'file=/tmp/RtmppXQ3Dy/bernoulli-202604182139-1-1e13fa.csv' \
      'profile_file=/tmp/RtmppXQ3Dy/bernoulli-profile-202604182139-1-3dcbd5.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/RtmppXQ3Dy/standata-38a03626d13e.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/RtmppXQ3Dy/bernoulli-202604182139-1-1e13fa.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/RtmppXQ3Dy/bernoulli-profile-202604182139-1-3dcbd5.csv 

...
Warning in '/tmp/RtmpPBGuEX/model-3a333d954fae.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmpPBGuEX/model-3a333d954fae.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/RtmpPBGuEX/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmpPBGuEX/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/RtmpPBGuEX/bernoulli-202603231737-1-5be56b.csv"
    [2] "/tmp/RtmpPBGuEX/bernoulli-202603231737-2-5be56b.csv"
    [3] "/tmp/RtmpPBGuEX/bernoulli-202603231737-3-5be56b.csv"
    [4] "/tmp/RtmpPBGuEX/bernoulli-202603231737-4-5be56b.csv"
...
```
    ...
    Ncells 1219781 65.2    2511068 134.2  1587032 84.8
    Vcells 2120817 16.2    8388608  64.0  4889185 37.4
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-03-23 17:37:30 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/RtmpPBGuEX/bernoulli-profile-202603231737-1-2c713b.csv"
      ...
      .. ..$ warmup  : num [1:4] 0.003 0.002 0.002 0.002
      .. ..$ sampling: num [1:4] 0.005 0.005 0.005 0.005
      .. ..$ total   : num [1:4] 0.008 0.007 0.007 0.007
...
```
    ...
    [1] "/tmp/RtmpPBGuEX/bernoulli-diagnostic-202603231737-1-0573c0.csv"
    [2] "/tmp/RtmpPBGuEX/bernoulli-diagnostic-202603231737-2-0573c0.csv"
    [3] "/tmp/RtmpPBGuEX/bernoulli-diagnostic-202603231737-3-0573c0.csv"
    [4] "/tmp/RtmpPBGuEX/bernoulli-diagnostic-202603231737-4-0573c0.csv"
...
```
    ...
    Running make /tmp/RtmpPBGuEX/model-3a3378632bb2 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/RtmpPBGuEX/model-3a3378632bb2.hpp /tmp/RtmpPBGuEX/model-3a3378632bb2.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/RtmpPBGuEX/model-3a3378632bb2.o /tmp/RtmpPBGuEX/model-3a3378632bb2.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/RtmpPBGuEX/model-3a3378632bb2.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/RtmpPBGuEX/model-3a3378632bb2
    rm /tmp/RtmpPBGuEX/model-3a3378632bb2.o /tmp/RtmpPBGuEX/model-3a3378632bb2.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/RtmpPBGuEX/standata-3a337e47ec1a.json' output \
      'file=/tmp/RtmpPBGuEX/bernoulli-202603231737-1-1e158d.csv' \
      'profile_file=/tmp/RtmpPBGuEX/bernoulli-profile-202603231737-1-3dcd68.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/RtmpPBGuEX/standata-3a337e47ec1a.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/RtmpPBGuEX/bernoulli-202603231737-1-1e158d.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/RtmpPBGuEX/bernoulli-profile-202603231737-1-3dcd68.csv 

...
Warning in '/tmp/Rtmpz3RzWp/model-37822d1ed770.stan', line 11, column 14: A
...
Warning in '/tmp/Rtmpz3RzWp/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14: A
    poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
Warning: The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
...
```
    ...
    [1] "/tmp/Rtmpz3RzWp/bernoulli-202512082149-1-5be2ba.csv"
    [2] "/tmp/Rtmpz3RzWp/bernoulli-202512082149-2-5be2ba.csv"
    [3] "/tmp/Rtmpz3RzWp/bernoulli-202512082149-3-5be2ba.csv"
    [4] "/tmp/Rtmpz3RzWp/bernoulli-202512082149-4-5be2ba.csv"
...
```
    ...
    Ncells 1217986 65.1    2504482 133.8  1589948 85.0
    Vcells 2123420 16.3    8388608  64.0  4907289 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2025-12-08 21:49:03 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/Rtmpz3RzWp/bernoulli-profile-202512082149-1-2c6e8a.csv"
...
```
    ...
    [1] "/tmp/Rtmpz3RzWp/bernoulli-diagnostic-202512082149-1-05710f.csv"
    [2] "/tmp/Rtmpz3RzWp/bernoulli-diagnostic-202512082149-2-05710f.csv"
    [3] "/tmp/Rtmpz3RzWp/bernoulli-diagnostic-202512082149-3-05710f.csv"
    [4] "/tmp/Rtmpz3RzWp/bernoulli-diagnostic-202512082149-4-05710f.csv"
...
```
    ...
    Running make /tmp/Rtmpz3RzWp/model-378253386c44 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/Rtmpz3RzWp/model-378253386c44.hpp /tmp/Rtmpz3RzWp/model-378253386c44.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/Rtmpz3RzWp/model-378253386c44.o /tmp/Rtmpz3RzWp/model-378253386c44.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.37.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.37.0/stan/lib/stan_math/lib/tbb"      /tmp/Rtmpz3RzWp/model-378253386c44.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/Rtmpz3RzWp/model-378253386c44
    rm /tmp/Rtmpz3RzWp/model-378253386c44.o /tmp/Rtmpz3RzWp/model-378253386c44.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/Rtmpz3RzWp/standata-37823a286473.json' output \
      'file=/tmp/Rtmpz3RzWp/bernoulli-202512082149-1-1e12dc.csv' \
      'profile_file=/tmp/Rtmpz3RzWp/bernoulli-profile-202512082149-1-3dcab7.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/Rtmpz3RzWp/standata-37823a286473.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/Rtmpz3RzWp/bernoulli-202512082149-1-1e12dc.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/Rtmpz3RzWp/bernoulli-profile-202512082149-1-3dcab7.csv 

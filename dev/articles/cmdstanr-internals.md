...
```
    ...
    [1] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1.stan"
...
```
    ...
    [1] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1"
...
Warning in '/tmp/RtmpqZMSoy/model-38ec1344ae7d.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmpqZMSoy/model-38ec1344ae7d.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/RtmpqZMSoy/model_287cd4f50e093cb87805d29fd774bdf8.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmpqZMSoy/model_287cd4f50e093cb87805d29fd774bdf8.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-01-5be424.csv"
    [2] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-02-5be424.csv"
    [3] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-03-5be424.csv"
    [4] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-04-5be424.csv"
...
```
    ...
    Ncells 1278963 68.4    2645242 141.3  1657310 88.6
    Vcells 2202994 16.9    8388608  64.0  4914036 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-09-14 19:04:34 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-profile-202609141904-01-2c6ff4.csv"
      ...
      ..$ model_name          : chr "bernoulli_38ecf2a7e1_model"
      ..$ adapt_engaged       : int 1
      ..$ adapt_delta         : num 0.8
...
```
    ...
    [1] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-diagnostic-202609141904-01-057279.csv"
    [2] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-diagnostic-202609141904-02-057279.csv"
    [3] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-diagnostic-202609141904-03-057279.csv"
    [4] "/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-diagnostic-202609141904-04-057279.csv"
...
```
    ...
    Running make /tmp/RtmpqZMSoy/model-38ec5884e8e4 \
      'STANCFLAGS +=  --name=bernoulli-38ecf2a7e1_model'

    --- Translating Stan model to C++ code ---
    bin/stanc --name=bernoulli-38ecf2a7e1_model --o=/tmp/RtmpqZMSoy/model-38ec5884e8e4.hpp /tmp/RtmpqZMSoy/model-38ec5884e8e4.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/RtmpqZMSoy/model-38ec5884e8e4.o /tmp/RtmpqZMSoy/model-38ec5884e8e4.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.39.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.39.0/stan/lib/stan_math/lib/tbb"      /tmp/RtmpqZMSoy/model-38ec5884e8e4.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/RtmpqZMSoy/model-38ec5884e8e4
    rm /tmp/RtmpqZMSoy/model-38ec5884e8e4.o /tmp/RtmpqZMSoy/model-38ec5884e8e4.hpp
...
```
    ...
    Running ./bernoulli-38ecf2a7e1 'id=1' random 'seed=1376020223' data \
      'file=/tmp/RtmpqZMSoy/standata-38ecbc213f4.json' output \
      'file=/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-01-1e1446.csv' \
      'profile_file=/tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-profile-202609141904-01-3dcc21.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/RtmpqZMSoy/standata-38ecbc213f4.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-202609141904-01-1e1446.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/RtmpqZMSoy/bernoulli-38ecf2a7e1-profile-202609141904-01-3dcc21.csv 

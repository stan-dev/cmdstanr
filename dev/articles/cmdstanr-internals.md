...
Warning in '/tmp/RtmphF1LwA/model-38904180807.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmphF1LwA/model-38904180807.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/RtmphF1LwA/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/RtmphF1LwA/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/RtmphF1LwA/bernoulli-202603030244-1-5be3c8.csv"
    [2] "/tmp/RtmphF1LwA/bernoulli-202603030244-2-5be3c8.csv"
    [3] "/tmp/RtmphF1LwA/bernoulli-202603030244-3-5be3c8.csv"
    [4] "/tmp/RtmphF1LwA/bernoulli-202603030244-4-5be3c8.csv"
...
```
    ...
    Ncells 1218531 65.1    2508697  134  1584634 84.7
    Vcells 2119132 16.2    8388608   64  4896574 37.4
...
```
    ...
    List of 8
     $ metadata                       :List of 41
      ...
      ..$ start_datetime      : chr "2026-03-03 02:44:43 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/RtmphF1LwA/bernoulli-profile-202603030244-1-2c6f98.csv"
...
```
    ...
    [1] "/tmp/RtmphF1LwA/bernoulli-diagnostic-202603030244-1-05721d.csv"
    [2] "/tmp/RtmphF1LwA/bernoulli-diagnostic-202603030244-2-05721d.csv"
    [3] "/tmp/RtmphF1LwA/bernoulli-diagnostic-202603030244-3-05721d.csv"
    [4] "/tmp/RtmphF1LwA/bernoulli-diagnostic-202603030244-4-05721d.csv"
...
```
    ...
    Running make /tmp/RtmphF1LwA/model-38907cacc65e \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/RtmphF1LwA/model-38907cacc65e.hpp /tmp/RtmphF1LwA/model-38907cacc65e.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/RtmphF1LwA/model-38907cacc65e.o /tmp/RtmphF1LwA/model-38907cacc65e.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/RtmphF1LwA/model-38907cacc65e.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/RtmphF1LwA/model-38907cacc65e
    rm /tmp/RtmphF1LwA/model-38907cacc65e.hpp /tmp/RtmphF1LwA/model-38907cacc65e.o
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/RtmphF1LwA/standata-3890572f9015.json' output \
      'file=/tmp/RtmphF1LwA/bernoulli-202603030244-1-1e13ea.csv' \
      'profile_file=/tmp/RtmphF1LwA/bernoulli-profile-202603030244-1-3dcbc5.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/RtmphF1LwA/standata-3890572f9015.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/RtmphF1LwA/bernoulli-202603030244-1-1e13ea.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/RtmphF1LwA/bernoulli-profile-202603030244-1-3dcbc5.csv 

...
Warning in '/tmp/Rtmp0fGg6Y/model-39007af449e9.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp0fGg6Y/model-39007af449e9.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/Rtmp0fGg6Y/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmp0fGg6Y/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/Rtmp0fGg6Y/bernoulli-202604100112-1-5be438.csv"
    [2] "/tmp/Rtmp0fGg6Y/bernoulli-202604100112-2-5be438.csv"
    [3] "/tmp/Rtmp0fGg6Y/bernoulli-202604100112-3-5be438.csv"
    [4] "/tmp/Rtmp0fGg6Y/bernoulli-202604100112-4-5be438.csv"
...
```
    ...
    Ncells 1224797 65.5    2519780 134.6  1598272 85.4
    Vcells 2127681 16.3    8388608  64.0  4902877 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-04-10 01:12:23 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/Rtmp0fGg6Y/bernoulli-profile-202604100112-1-2c7008.csv"
...
```
    ...
    [1] "/tmp/Rtmp0fGg6Y/bernoulli-diagnostic-202604100112-1-05728d.csv"
    [2] "/tmp/Rtmp0fGg6Y/bernoulli-diagnostic-202604100112-2-05728d.csv"
    [3] "/tmp/Rtmp0fGg6Y/bernoulli-diagnostic-202604100112-3-05728d.csv"
    [4] "/tmp/Rtmp0fGg6Y/bernoulli-diagnostic-202604100112-4-05728d.csv"
...
```
    ...
    Running make /tmp/Rtmp0fGg6Y/model-390070a72f97 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/Rtmp0fGg6Y/model-390070a72f97.hpp /tmp/Rtmp0fGg6Y/model-390070a72f97.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/Rtmp0fGg6Y/model-390070a72f97.o /tmp/Rtmp0fGg6Y/model-390070a72f97.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/Rtmp0fGg6Y/model-390070a72f97.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/Rtmp0fGg6Y/model-390070a72f97
    rm /tmp/Rtmp0fGg6Y/model-390070a72f97.o /tmp/Rtmp0fGg6Y/model-390070a72f97.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/Rtmp0fGg6Y/standata-390073e9d51c.json' output \
      'file=/tmp/Rtmp0fGg6Y/bernoulli-202604100112-1-1e145a.csv' \
      'profile_file=/tmp/Rtmp0fGg6Y/bernoulli-profile-202604100112-1-3dcc35.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/Rtmp0fGg6Y/standata-390073e9d51c.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/Rtmp0fGg6Y/bernoulli-202604100112-1-1e145a.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/Rtmp0fGg6Y/bernoulli-profile-202604100112-1-3dcc35.csv 

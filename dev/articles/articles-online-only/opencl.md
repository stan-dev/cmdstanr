...
Users can expect speedups with OpenCL when using vectorized probability
distribution functions (functions with the `_lpdf` or `_lpmf` suffix)
and when the input variables contain at least 20,000 elements.

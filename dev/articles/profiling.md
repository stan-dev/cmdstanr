...
```
    ...
    1     priors 139826855569216 0.00426557  0.003356069  0.000909501       35060
    2 likelihood 139826855569216 0.63866468  0.504957250  0.133707430       52590
...
```
    ...
    [[1]]
            name       thread_id  total_time forward_time reverse_time chain_stack
    1 likelihood 139691950118720 0.422870510  0.421811190  0.001059321       51369
    2     priors 139691950118720 0.004716536  0.003418131  0.001298405       34246
      no_chain_stack autodiff_calls no_autodiff_calls
    1          17123          17123                 1
    2          34246          17123                 1
...
```
    ...
    [1] "/tmp/Rtmpzez6lT/model_6580008f67848265f3dfd0e7ae3b0600-profile-202601022132-1-8069fd.csv"
